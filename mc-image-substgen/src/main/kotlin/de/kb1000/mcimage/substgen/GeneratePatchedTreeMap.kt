...
val jdkPatchTargetDir = Path("java.base")

fun generatePatchedTreeMap() {
    val targetFile = jdkPatchTargetDir / "java" / "util" / "TreeMap.class"
    targetFile.parent.createDirectories()

    val classReader = TreeMap::class.java.module.getResourceAsStream("java/util/TreeMap.class").use(::ClassReader)
